    ...
    <>
      ...
      <div className="mt-[26px] border-b border-bg-[#46A358] flex justify-between items-center  ">
        ...
        <div className="flex gap-12">
          <h3
            onClick={() => navigate("/")}
            className=" cursor-pointer relative  before:absolute  before:w-full before:h-1 hover:before:bg-[#46A358] before:bottom-[-28px] before:left-0"
          >
            Home
          </h3>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className=" flex items-center gap-2 justify-center w-[100px] h-[35px] rounded-[6px] bg-[#46A358] text-white"
          >
            <LoginOutlined />
            Login
          </button>
